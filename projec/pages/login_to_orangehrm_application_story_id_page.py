"""LoginToOrangehrmApplicationStoryIdPage — synthesized by phoenix automate (pom mode)."""
...
class LoginToOrangehrmApplicationStoryIdPage(BasePage):
    """Page object for login_to_orangehrm_application_story_id tests."""

    URL_PATH = ""

    def tc_001_login_to_orangehrm_application_st(self) -> None:
        """tc 001 login to orangehrm application st."""
