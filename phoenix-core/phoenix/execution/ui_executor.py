...
class UIExecutor:
    ...
    def execute_test(
        self, test_script_path: str, screenshot_dir: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if screenshot_dir:
                ...
                screenshot_path = str(
                    screenshot_dir_path / f"screenshot_{Path(test_script_path).stem}.png"
                )
            ...
            if screenshot_dir:
                ...
                screenshot_dir_path.mkdir(parents=True, exist_ok=True)
                screenshot_path = str(
                    screenshot_dir_path / f"failure_{Path(test_script_path).stem}.png"
                )
                page.screenshot(path=screenshot_path)
