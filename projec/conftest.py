"""Pytest configuration for projec — generated by phoenix init."""
...
print(f"[CONFTEST DEBUG] Loading projec/conftest.py from current directory: {Path.cwd()}")
...
BASE_URL = os.environ.get("APP_URL", "https://opensource-demo.orangehrmlive.com/web/index.php/auth")
...
def page(context, intelligent_runtime, request) -> Page:
    ...
    if intelligent_runtime:
        ...
        test_name = request.node.name if hasattr(request, 'node') else "projec_test"
...
# ---------------------------------------------------------------------------
# Intelligent Runtime Finalization
# ---------------------------------------------------------------------------
