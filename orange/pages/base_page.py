...
- Intelligent Runtime integration for DOM reuse and MCP decisions
...
class BasePage:
    """Base class for all page objects in orange with Intelligent Runtime support."""
    ...
    def __init__(self, page: Page) -> None:
        ...
        # Check if page is intelligent wrapper
        self._is_intelligent = hasattr(page, '_intelligent_runtime')
        if self._is_intelligent:
            logger.info("[BASE PAGE] Using Intelligent Page wrapper for DOM reuse and MCP decisions")
    
    def _get_intelligent_page(self) -> Page:
        """Get the intelligent page wrapper if available, otherwise return standard page."""
        if self._is_intelligent:
            return self._page
        return self._page
    ...
    def navigate(self, path: Optional[str] = None) -> None:
        ...
        if self._is_intelligent:
            logger.info(f"[BASE PAGE] Using intelligent navigation to {url}")
    ...
    def click(self, locator: Locator) -> None:
        ...
        if self._is_intelligent:
            logger.info(f"[BASE PAGE] Intelligent click on locator")
    ...
    def fill(self, locator: Locator, value: str) -> None:
        ...
        if self._is_intelligent:
            logger.info(f"[BASE PAGE] Intelligent fill on locator")
