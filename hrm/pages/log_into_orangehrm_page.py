"""LogIntoOrangehrmPage — synthesized by phoenix automate (pom mode)."""
...
class LogIntoOrangehrmPage(BasePage):
    """Page object for log_into_orangehrm tests."""

    URL_PATH = ""

    def tc_001_log_into_orangehrm(self) -> None:
        """tc 001 log into orangehrm."""
        ...
        # --- Step 2: User enters valid username. ---
        fill_ready(self._page, self._page.get_by_label("User", exact=True), "enters valid username.", "User field")

        # Expected: "User" field contains the value "enters valid username."
        # --- Step 3: User enters valid password. ---
        fill_ready(self._page, self._page.get_by_label("Password", exact=True), "enters valid password.", "Password field")
