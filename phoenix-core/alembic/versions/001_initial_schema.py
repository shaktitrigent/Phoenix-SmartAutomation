...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "risk_level", sa.Enum("SMOKE", "REGRESSION", "EDGE", name="testrisk"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "RUNNING", "PASSED", "FAILED", "SKIPPED", "ERROR", name="executionstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_test_executions_execution_id"), "test_executions", ["execution_id"], unique=False
    )
    op.create_index(
        op.f("ix_test_executions_test_case_id"), "test_executions", ["test_case_id"], unique=False
    )
