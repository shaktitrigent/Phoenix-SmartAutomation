        ...
        if json_report_path.exists():
            try:
                with open(json_report_path, "r") as f:
                    ...
                    execution_result["total_tests"] = json_data.get("total", 0)
                    execution_result["passed_tests"] = json_data.get("passed", 0)
                    execution_result["failed_tests"] = json_data.get("failed", 0)
                    execution_result["skipped_tests"] = json_data.get("skipped", 0)
            except Exception:
                pass
